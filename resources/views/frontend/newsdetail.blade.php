	...
	<head>
		...
		<body>	
			...
			<section class="post-content-area single-post-area" style="margin-top:120px">
				<div class="container">
					<div class="row">
							...
							<div class="single-post row">
								<div class="col-lg-12">
									<div class="feature-img">
										<img class="img-fluid" src="{{ asset('/news/img/'.$news->img_cover) }}" alt="">
									</div>									
								</div>
                    ...
                    @endif																	
								...
								<div class="col-lg-9 col-md-9">
									<a class="posts-title" href="#"><h3>{{ title_case($news->title) }}</h3></a>
									{!! $news->content !!}
								</div>
							</div>
						</div>
