      ...
      <div class="box-body">
        <div class="box-header with-border">
          ...
          <div class="form-group">
            <form id="save-about" action="{{ route('post.update',$news->id) }}" method="post" enctype="multipart/form-data">
              {{ csrf_field() }}
              <label for="img_cover">Cover Image</label>
              <input type="file" id="img_cover-save" name="img_cover">
              <br>
              <img src="{{ asset('news/img/'.$news->img_cover) }}" width="200px">
            ...
            <div class="form-group">
              <input class="form-control" id="title" value="{{ $news->title }}" placeholder="Title">
            </div>
            <div class="form-group">
